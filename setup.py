#!/usr/bin/env python
"""
Package metadata for courses_api.
"""
import os
import re
import sys
...
VERSION = get_version('courses_api', '__init__.py')
...
setup(
    name='EdxCoursesAPIProject',
    version=VERSION,
    description="""an app of djnago for filtering out courses of open edx on basis of several things""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Abdul-Muqadim',
    author_email='muqadim2000@gmail.com',
    url='https://github.com/openedx/edx-courses-api',
    packages=find_packages(
        include=['courses_api', 'courses_api.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "courses_api = courses_api.apps:CoursesApiConfig",
        ],
    },
