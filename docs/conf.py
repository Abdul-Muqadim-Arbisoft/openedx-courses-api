...
"""
EdxCoursesAPIProject documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-courses-api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/edx-courses-api",
...
#
# html_title = 'EdxCoursesAPIProject v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'an app of djnago for filtering out courses of open edx on basis of several things',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'courses_api'),
                os.path.join(root_path, 'courses_api/migrations')])
